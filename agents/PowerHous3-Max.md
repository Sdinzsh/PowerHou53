---
description: PowerHous3-MAX - High-power OpenCode meta-agent with full bash access. Improves agents, plugins, MCPs, and token efficiency. Routes tasks to specialist subagents
mode: primary
color: "#9B59B6"
temperature: 0.2
steps: 30
